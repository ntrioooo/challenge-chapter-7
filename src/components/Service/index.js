        ...
        <section id="our__services">
            <div className="container">
                ...
                <div className="col-md-5">
                    <img src="assets/img_service.png" className="img-fluid" alt="Services"/>
                </div>
                <div className="col-md-5 ms-5">
                    <h3>Best Car Rental for any kind of trip in (Lokasimu)!</h3>
                    <p className="mt-4">Sewa mobil di (Lokasimu) bersama Binar Car Rental jaminan harga lebih <br/> murah dibandingkan yang lain, kondisi mobil baru, serta kualitas <br/> pelayanan terbaik untuk perjalanan wisata, bisnis, wedding, meeting, dll.</p>
                    <div className="services">
                    <img src="assets/Group 53.png" alt="icon" style={{float:"left"}}/>
