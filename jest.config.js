...
module.exports = {
  ...
  // cacheDirectory: "C:\\Users\\MOHAMAD\\AppData\\Local\\Temp\\jest",
  ...
  // A list of paths to modules that run
  // some code to configure or set up the testing framework before each test
  // setupFilesAfterEnv: [],
